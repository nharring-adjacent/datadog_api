...
pub async fn create_event(configuration: &configuration::Configuration, body: crate::models::EventCreateRequest) -> Result<crate::models::EventCreateResponse, Error<CreateEventError>> {
...
pub async fn get_event(configuration: &configuration::Configuration, event_id: i64) -> Result<crate::models::EventResponse, Error<GetEventError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/api/v1/events/{event_id}", configuration.base_path, event_id=event_id);
...
pub async fn list_events(configuration: &configuration::Configuration, start: i64, end: i64, priority: Option<crate::models::EventPriority>, sources: Option<&str>, tags: Option<&str>, unaggregated: Option<bool>, exclude_aggregate: Option<bool>, page: Option<i32>) -> Result<crate::models::EventListResponse, Error<ListEventsError>> {
    ...
    if let Some(ref local_var_str) = unaggregated {
        local_var_req_builder = local_var_req_builder.query(&[("unaggregated", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = exclude_aggregate {
        local_var_req_builder = local_var_req_builder.query(&[("exclude_aggregate", &local_var_str.to_string())]);
    }
