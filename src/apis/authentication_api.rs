...
pub async fn validate(configuration: &configuration::Configuration, ) -> Result<crate::models::AuthenticationValidationResponse, Error<ValidateError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/api/v1/validate", configuration.base_path);
